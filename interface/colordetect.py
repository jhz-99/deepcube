...
def colorMatch(name):
    # cube_rgb = picture
    os.chdir("C:\\Users\\guoyy\\Desktop\\deepcube\\deepcube\\interface\\static\\images")
    ...
    def getcolor(x1, y1, x2, y2):
        ...
        if (white_num == max_num):
            return ('D')
        elif (orange_num == max_num):
            return ('B')
        elif (blue_num == max_num):
            return ('L')
        elif (green_num == max_num):
            return ('R')
        elif (yellow_num == max_num):
            return ('U')
        elif (red_num == max_num):
            return ('F')
